...
Você pode acessar e baixar os arquivos de amostras diretamente através do link da pasta no Google Drive:

- **[Acessar Pasta de Amostras no Google Drive](https://drive.google.com/drive/folders/1hP-pOhNtxHFkyTk3RZWrUajOjoE7cTgC?usp=share_link)**
...
* **Extração via STAC:** Conexão com catálogos abertos (AWS *Earth Search*) para aquisição otimizada de bandas espectrais (`red`, `nir`) do Sentinel-2 sem necessidade de *downloads* massivos prévios.
